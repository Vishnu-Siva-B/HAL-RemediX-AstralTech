...
const DoctorSignupPage = () => {
  ...
  const validateFields = () => {
    ...
    if (step === 1) {
      ...
      if (!formData.doctorIdNo.trim()) newErrors.doctorIdNo = "Doctor ID Number is required.";
    ...
    <>
      ...
      >
        ...
        <div className="max-w-md z-50 w-full mx-auto p-6 md:p-8 bg-white dark:bg-black rounded-2xl shadow-lg">
          ...
          <p className="text-gray-600 text-sm mt-2 dark:text-gray-300">Sign up as Doctor</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            {step === 3 && (
              <>
                ...
                <LabelInput name="doctorIdNo" label="Doctor ID Number" value={formData.doctorIdNo} error={errors.doctorIdNo} onChange={handleInputChange} />
                <LabelInput name="speciality" label="Speciality" value={formData.speciality} error={errors.speciality} onChange={handleInputChange} />
