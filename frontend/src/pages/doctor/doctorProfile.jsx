...
import signinImg from "../../static/main/images/doctor.jpg";
import ImageUpload from "../../components/imageUpload/imageUpload";
import StudentProfile from "@/components/Profile/doctorProfile";
import AccountSecurity from "../../components/accountSecurity/accountSecurity";
import Certificate from "../../components/subscription/subscription";
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <header className="sticky top-0 flex h-16 items-center justify-between border-b bg-background px-4 md:px-6 z-50">
        <nav className="hidden md:flex flex-row items-center gap-5 lg:gap-6">
          ...
          <a href="#" className="text-muted-foreground transition-colors hover:text-foreground" onClick={() => navigate("/doctor/dashboard")}>
            Dashboard
          </a>
          <a href="#" className="text-muted-foreground transition-colors hover:text-foreground" onClick={() => navigate("/doctor/appointment")}>
            Patients
          </a>
          <a href="#" className="text-foreground transition-colors hover:text-foreground" onClick={() => navigate("/doctor/profile")}>
            Profile
          </a>
          <a href="#" className="text-muted-foreground transition-colors hover:text-foreground" onClick={() => navigate("")}>
            Meet
          </a>
        </nav>
